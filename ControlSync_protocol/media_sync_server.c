...
{
uint8_t i;
total_receivers =  NET_get_num_connections();
#if CTRL_MODE
...
//	uint8_t tx_buff[7];
//
//	tx_buff[0]=str_ctrl_sync[id_receiver].receiver_id;
//	tx_buff[1]=str_ctrl_sync[id_receiver].total_receivers;
//	tx_buff[2]=str_ctrl_sync[id_receiver].total_packets;
//	tx_buff[3]=((str_ctrl_sync[id_receiver].tx_delay & 0xFF00) >> 8);
//	tx_buff[4]=((str_ctrl_sync[id_receiver].tx_delay) & 0xFF);
//	tx_buff[5]=((str_ctrl_sync[id_receiver].inter_slave_delay & 0xFF00) >> 8);
//	tx_buff[6]=((str_ctrl_sync[id_receiver].inter_slave_delay) & 0xFF);
//
