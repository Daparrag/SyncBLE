...
/**
 * Get_EVENT_CB() 
 * return a event on top of the evt queue.
 * 
 */
 ...
 * delete a event allocated on top of the evt queue.
 * 
 */   
...
#else
void HCI_Isr_Event_Handler_CB();/*This is a variation of the clasic HCI_Isr() where is introduced a arrival timestamp and priority queue*/
void HCI_Isr(void);
